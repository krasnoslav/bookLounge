            ...
            <div class="mb-3">
                ...
                <select name="bookGenre" id="bookGenre">
                    @foreach ($bookGenres as $bookGenre)
                        <option value="{{ $bookGenre->id }}">{{ $bookGenre->bookGenre }}</option>
                    @endforeach
                </select>
            </div>
            <div class="mb-3">
                ...
                <select name="bookCover" id="bookCover">
                    @foreach ($bookCovers as $bookCover)
                        <option value="{{ $bookCover->id }}">{{ $bookCover->bookCover }}</option>
                    @endforeach
                </select>
            </div>
            <div class="mb-3">
                <label for="pagesCount" class="form-label">Количество страниц</label>
                <input type="number" class="form-control" id="pagesCount" name="pagesCount">
            </div>
            <div class="mb-3">
